...
public class UltraGameTarget : TargetRules
{
	public UltraGameTarget(TargetInfo Target) : base(Target)
	{
	...
	internal static void ApplySharedUltraTargetSettings(TargetRules Target)
    {
        ...
        if (Target.BuildEnvironment == TargetBuildEnvironment.Unique)
        {
            ...
            UltraGameTarget.ConfigureGameFeaturePlugins(Target);
        }
        else
        {
            // !!!!!!!!!!!! WARNING !!!!!!!!!!!!!
            ...
            else
            {
                ...
                if (!bHasWarnedAboutShared)
                {
                    ...
                    Logger.LogWarning("UltraGameEOS and dynamic target options are disabled when packaging from an installed version of the engine");
                }
            }
        }
    }
