...
#include "UltraContextEffectsInterface.generated.h"
 ...
 */
 ...
 class ULTRAGAME_API UUltraContextEffectsInterface : public UInterface
 {
	 GENERATED_BODY()

 };
 
 class ULTRAGAME_API IUltraContextEffectsInterface : public IInterface
 {
	 GENERATED_BODY()
