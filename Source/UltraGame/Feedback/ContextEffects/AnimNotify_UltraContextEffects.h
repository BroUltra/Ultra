...
#include "AnimNotify_UltraContextEffects.generated.h"

/**
 *
 */
USTRUCT(BlueprintType)
struct ULTRAGAME_API FUltraContextEffectAnimNotifyVFXSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct ULTRAGAME_API FUltraContextEffectAnimNotifyAudioSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct ULTRAGAME_API FUltraContextEffectAnimNotifyTraceSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct ULTRAGAME_API FUltraContextEffectAnimNotifyPreviewSettings
{
	GENERATED_BODY()
	...
	// Preview Library
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Preview, meta = (AllowedClasses = "/Script/UltraGame.UltraContextEffectsLibrary"))
...
class ULTRAGAME_API UAnimNotify_UltraContextEffects : public UAnimNotify
{
	GENERATED_BODY()

public:
	UAnimNotify_UltraContextEffects();
	...
	// Scale to spawn the particle system at
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AnimNotify", meta = (ExposeOnSpawn = true))
	FUltraContextEffectAnimNotifyVFXSettings VFXProperties;

	// Scale to spawn the particle system at
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AnimNotify", meta = (ExposeOnSpawn = true))
	FUltraContextEffectAnimNotifyAudioSettings AudioProperties;
	...
	FUltraContextEffectAnimNotifyTraceSettings TraceProperties;
	...
	FUltraContextEffectAnimNotifyPreviewSettings PreviewProperties;
#endif
