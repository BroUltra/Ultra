...
#include "UltraAbilityTagRelationshipMapping.generated.h"

class UObject;

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FUltraAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class UUltraAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FUltraAbilityTagRelationship> AbilityTagRelationships;
