...
#include "UltraGameplayCueManager.generated.h"
...
/**
 * UUltraGameplayCueManager
 *
 * Game-specific manager for gameplay cues
 */
UCLASS()
class UUltraGameplayCueManager : public UGameplayCueManager
{
	GENERATED_BODY()

public:
	UUltraGameplayCueManager(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	static UUltraGameplayCueManager* Get();
