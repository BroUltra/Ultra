...
#include "UltraTestControllerBootTest.generated.h"

class UObject;

UCLASS()
class UUltraTestControllerBootTest : public UGauntletTestControllerBootTest
{
	GENERATED_BODY()
...
protected:
	...
	//@TODO: Comment and delay copied from UltraGame.  Still needed?
