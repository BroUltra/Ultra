...
{
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(Ability_ActivateFail_IsDespawned, "Ability.ActivateFail.IsDespawned", "Ability failed to activate because its owner is despawned.");
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(Ability_Behavior_SurvivesDespawn, "Ability.Behavior.SurvivesDespawn", "An ability with this type tag should not be canceled due to despawn.");

	UE_DEFINE_GAMEPLAY_TAG_COMMENT(InputTag_Move, "InputTag.Move", "Move input.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(InputTag_MoveVertical, "InputTag.MoveVertical", "Vertical movement input.");
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(GameplayEvent_Despawn, "GameplayEvent.Despawn", "Event that fires on despawn. This event only fires on the server.");
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(Status_Despawn, "Status.Despawn", "Target has the despawn status.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(Status_Despawn_Despawning, "Status.Despawn.Despawning", "Target has begun the despawn process.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(Status_Despawn_Despawned, "Status.Despawn.Despawned", "Target has finished the despawn process.");
