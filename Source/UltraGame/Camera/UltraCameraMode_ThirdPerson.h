...
#include "UltraCameraMode_ThirdPerson.generated.h"

class UCurveVector;

/**
 * UUltraCameraMode_ThirdPerson
 *
 *	A basic third person camera mode.
 */
UCLASS(Abstract, Blueprintable)
class UUltraCameraMode_ThirdPerson : public UUltraCameraMode
{
	GENERATED_BODY()
...
public:
	...
	TArray<FUltraPenetrationAvoidanceFeeler> PenetrationAvoidanceFeelers;
