...
#include "UltraPenetrationAvoidanceFeeler.generated.h"

/**
 * Struct defining a feeler ray used for camera penetration avoidance.
 */
USTRUCT()
struct FUltraPenetrationAvoidanceFeeler
{
	GENERATED_BODY()
	...
	FUltraPenetrationAvoidanceFeeler()
	...
	FUltraPenetrationAvoidanceFeeler(const FRotator& InAdjustmentRot,
