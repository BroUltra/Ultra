...
class ULTRAGAME_API UIndicatorDescriptor : public UObject
{
	GENERATED_BODY()
...
public:
	UUltraIndicatorManagerComponent* GetIndicatorManagerComponent() { return ManagerPtr.Get(); }
	void SetIndicatorManagerComponent(UUltraIndicatorManagerComponent* InManager);
...
private:
	...
	UPROPERTY()
	TWeakObjectPtr<UUltraIndicatorManagerComponent> ManagerPtr;
