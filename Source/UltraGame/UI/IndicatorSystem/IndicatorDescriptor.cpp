...
void UIndicatorDescriptor::SetIndicatorManagerComponent(UUltraIndicatorManagerComponent* InManager)
{
...
{
	if (UUltraIndicatorManagerComponent* Manager = ManagerPtr.Get())
	{
