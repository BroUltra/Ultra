...
#include "UltraBoundActionButton.h"

#include "CommonInputSubsystem.h"
#include "Delegates/Delegate.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(UltraBoundActionButton)

class UCommonButtonStyle;

void UUltraBoundActionButton::NativeConstruct()
{
...
void UUltraBoundActionButton::HandleInputMethodChanged(ECommonInputType NewInputMethod)
{
