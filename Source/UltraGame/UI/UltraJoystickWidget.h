...
#include "UltraJoystickWidget.generated.h"
...
/**
 *  A UMG wrapper for the ultra virtual joystick.
 *
 ...
 */
UCLASS(meta=( DisplayName="Ultra Joystick" ))
class ULTRAGAME_API UUltraJoystickWidget : public UUltraSimulatedInputWidget
{
	GENERATED_BODY()
	
public:
	
	UUltraJoystickWidget(const FObjectInitializer& ObjectInitializer);
