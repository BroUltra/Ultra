...
#include "UltraSimulatedInputWidget.generated.h"
 ...
 */
UCLASS(meta=( DisplayName="Ultra Simulated Input Widget" ))
class ULTRAGAME_API UUltraSimulatedInputWidget : public UCommonUserWidget
{
	GENERATED_BODY()
	
public:
	
	UUltraSimulatedInputWidget(const FObjectInitializer& ObjectInitializer);
