...
#include UE_INLINE_GENERATED_CPP_BY_NAME(UltraHUD)
...
AUltraHUD::AUltraHUD(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	PrimaryActorTick.bStartWithTickEnabled = false;
}

void AUltraHUD::PreInitializeComponents()
{
...
void AUltraHUD::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
...
void AUltraHUD::GetDebugActorList(TArray<AActor*>& InOutList)
{
