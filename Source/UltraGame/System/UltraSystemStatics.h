...
#include "UltraSystemStatics.generated.h"
...
UCLASS()
class UUltraSystemStatics : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly, Category="Ultra", meta = (WorldContext = "WorldContextObject"))
