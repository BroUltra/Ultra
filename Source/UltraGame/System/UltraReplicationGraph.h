...
#include "UltraReplicationGraph.generated.h"

class AGameplayDebuggerCategoryReplicator;

DECLARE_LOG_CATEGORY_EXTERN(LogUltraRepGraph, Display, All);

/** Ultra Replication Graph implementation. See additional notes in UltraReplicationGraph.cpp! */
UCLASS(transient, config=Engine)
class UUltraReplicationGraph : public UReplicationGraph
{
	GENERATED_BODY()

public:
	UUltraReplicationGraph();
...
private:
	...
	/** Classes that had their replication settings explictly set by code in UUltraReplicationGraph::InitGlobalActorClassSettings */
	TArray<UClass*> ExplicitlySetClasses;
};

UCLASS()
class UUltraReplicationGraphNode_AlwaysRelevant_ForConnection : public UReplicationGraphNode_AlwaysRelevant_ForConnection
{
	GENERATED_BODY()
...
*/
UCLASS()
class UUltraReplicationGraphNode_PlayerStateFrequencyLimiter : public UReplicationGraphNode
{
	GENERATED_BODY()
