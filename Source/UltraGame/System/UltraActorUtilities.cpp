...
#include "UltraActorUtilities.h"

#include "GameFramework/Actor.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(UltraActorUtilities)

EBlueprintExposedNetMode UUltraActorUtilities::SwitchOnNetMode(const UObject* WorldContextObject)
{
