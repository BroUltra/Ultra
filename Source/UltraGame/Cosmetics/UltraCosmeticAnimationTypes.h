...
#include "UltraCosmeticAnimationTypes.generated.h"
...
struct FUltraAnimLayerSelectionEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FUltraAnimLayerSelectionSet
{
	GENERATED_BODY()
	...
	TArray<FUltraAnimLayerSelectionEntry> LayerRules;
...
USTRUCT(BlueprintType)
struct FUltraAnimBodyStyleSelectionEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FUltraAnimBodyStyleSelectionSet
{
	GENERATED_BODY()
		
	// List of layer rules to apply, first one that matches will be used
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta=(TitleProperty=Mesh))
	TArray<FUltraAnimBodyStyleSelectionEntry> MeshRules;
