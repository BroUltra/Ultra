 ...
 */
UCLASS()
class ULTRAGAME_API AUltraPawn : public AModularPawn, public IUltraTeamAgentInterface
{
	GENERATED_BODY()

public:

	AUltraPawn(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
