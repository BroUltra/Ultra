...
#include "UltraPlatformEmulationSettings.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(UltraPlatformEmulationSettings)

#define LOCTEXT_NAMESPACE "UltraCheats"

UUltraPlatformEmulationSettings::UUltraPlatformEmulationSettings()
{
}

FName UUltraPlatformEmulationSettings::GetCategoryName() const
{
	return FApp::GetProjectName();
}

FName UUltraPlatformEmulationSettings::GetPretendBaseDeviceProfile() const
{
	return PretendBaseDeviceProfile;
}

FName UUltraPlatformEmulationSettings::GetPretendPlatformName() const
{
	return PretendPlatform;
}

#if WITH_EDITOR
void UUltraPlatformEmulationSettings::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
...
void UUltraPlatformEmulationSettings::PostReloadConfig(FProperty* PropertyThatWasLoaded)
{
...
void UUltraPlatformEmulationSettings::PostInitProperties()
{
...
void UUltraPlatformEmulationSettings::OnPlayInEditorStarted() const
{
...
void UUltraPlatformEmulationSettings::ApplySettings()
{
...
void UUltraPlatformEmulationSettings::ChangeActivePretendPlatform(FName NewPlatformName)
{
...
TArray<FName> UUltraPlatformEmulationSettings::GetKnownPlatformIds() const
{
...
TArray<FName> UUltraPlatformEmulationSettings::GetKnownDeviceProfiles() const
{
	TArray<FName> Results;
...
void UUltraPlatformEmulationSettings::PickReasonableBaseDeviceProfile()
{
