...
namespace UltraGameplayTags
{
	...
	ULTRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(SetByCaller_Score);
	...
	ULTRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Movement_Mode_Custom_Fly);
	ULTRAGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(Movement_Mode_Custom_Dash);
};