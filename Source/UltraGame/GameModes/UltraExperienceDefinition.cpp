...
#include UE_INLINE_GENERATED_CPP_BY_NAME(UltraExperienceDefinition)

#define LOCTEXT_NAMESPACE "UltraSystem"

UUltraExperienceDefinition::UUltraExperienceDefinition()
{
}

#if WITH_EDITOR
EDataValidationResult UUltraExperienceDefinition::IsDataValid(TArray<FText>& ValidationErrors)
{
...
void UUltraExperienceDefinition::UpdateAssetBundleData()
{
