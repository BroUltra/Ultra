...
#include "UltraUserFacingExperienceDefinition.generated.h"
...
class UUltraUserFacingExperienceDefinition : public UPrimaryDataAsset
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category=Experience, meta=(AllowedTypes="UltraExperienceDefinition"))
