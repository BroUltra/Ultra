...
#include "UltraGameMode.generated.h"
 ...
 */
DECLARE_MULTICAST_DELEGATE_TwoParams(FOnUltraGameModePlayerInitialized, AGameModeBase* /*GameMode*/, AController* /*NewPlayer*/);
...
class AUltraGameMode : public AModularGameModeBase
{
	GENERATED_BODY()

public:

	AUltraGameMode(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	UFUNCTION(BlueprintCallable, Category = "Ultra|Pawn")
	const UUltraPawnData* GetPawnDataForController(const AController* InController) const;
	...
	FOnUltraGameModePlayerInitialized OnGameModePlayerInitialized;
