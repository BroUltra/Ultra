...
#include "UltraGameFeaturePolicy.generated.h"
...
class UUltraGameFeaturePolicy : public UDefaultGameFeaturesProjectPolicies
{
	GENERATED_BODY()

public:
	ULTRAGAME_API static UUltraGameFeaturePolicy& Get();

	UUltraGameFeaturePolicy(const FObjectInitializer& ObjectInitializer);
...
// checked
UCLASS()
class UUltraGameFeature_HotfixManager : public UObject, public IGameFeatureStateChangeObserver
{
	GENERATED_BODY()
...
// checked
UCLASS()
class UUltraGameFeature_AddGameplayCuePaths : public UObject, public IGameFeatureStateChangeObserver
{
	GENERATED_BODY()
