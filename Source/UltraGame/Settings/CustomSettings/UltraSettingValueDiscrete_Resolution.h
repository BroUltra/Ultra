...
#include "UltraSettingValueDiscrete_Resolution.generated.h"
...
UCLASS()
class UUltraSettingValueDiscrete_Resolution : public UGameSettingValueDiscrete
{
	GENERATED_BODY()
	
public:

	UUltraSettingValueDiscrete_Resolution();
