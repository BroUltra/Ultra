...
USTRUCT()
struct FUltraScalabilitySnapshot
{
	GENERATED_BODY()

	FUltraScalabilitySnapshot();
 ...
 */
UCLASS()
class UUltraSettingsLocal : public UGameUserSettings
{
	GENERATED_BODY()
...
public:
	...
	static UUltraSettingsLocal* Get();
...
public:
	...
	DECLARE_EVENT(UUltraSettingsLocal, FPerfStatSettingsChanged);
...
private:
	...
	UPROPERTY(Config)
	TMap<EUltraDisplayablePerformanceStat, EUltraStatDisplayMode> DisplayStatList;
...
private:
	...
	void OverrideQualityLevelsToScalabilityMode(const FUltraScalabilitySnapshot& InMode, Scalability::FQualityLevels& InOutLevels);
...
private:
	...
	FUltraScalabilitySnapshot DeviceDefaultScalabilitySettings;
...
private:
	...
	// Audio - Volume
public:
	DECLARE_EVENT_OneParam(UUltraSettingsLocal, FAudioDeviceChanged, const FString& /*DeviceId*/);
