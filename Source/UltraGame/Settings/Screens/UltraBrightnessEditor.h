...
#include "UltraBrightnessEditor.generated.h"
...
UCLASS(Abstract)
class UUltraBrightnessEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	UUltraBrightnessEditor(const FObjectInitializer& Initializer);
