...
#include "UltraSafeZoneEditor.generated.h"
...
UCLASS(Abstract)
class UUltraSafeZoneEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	UUltraSafeZoneEditor(const FObjectInitializer& Initializer);
