...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UBattle_PlayerSpawningManagementComponent_Statics::DependentSingletons) < 16);
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UBattle_PlayerSpawningManagementComponent_Statics::ClassParams = {
		...
		0,
		0x00A000A4u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UBattle_PlayerSpawningManagementComponent_Statics::Class_MetaDataParams), Z_Construct_UClass_UBattle_PlayerSpawningManagementComponent_Statics::Class_MetaDataParams)
	};
	...
	struct Z_CompiledInDeferFile_FID_Users_UltraBro_Documents_Unreal_Projects_Ultra_5_3_Plugins_GameFeatures_UltraCore_Source_UltraCoreRuntime_Private_Battle_PlayerSpawningManagementComponent_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_UltraBro_Documents_Unreal_Projects_Ultra_5_3_Plugins_GameFeatures_UltraCore_Source_UltraCoreRuntime_Private_Battle_PlayerSpawningManagementComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBattle_PlayerSpawningManagementComponent, UBattle_PlayerSpawningManagementComponent::StaticClass, TEXT("UBattle_PlayerSpawningManagementComponent"), &Z_Registration_Info_UClass_UBattle_PlayerSpawningManagementComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBattle_PlayerSpawningManagementComponent), 2941920212U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_UltraBro_Documents_Unreal_Projects_Ultra_5_3_Plugins_GameFeatures_UltraCore_Source_UltraCoreRuntime_Private_Battle_PlayerSpawningManagementComponent_h_3580980755(TEXT("/Script/UltraCoreRuntime"),
		Z_CompiledInDeferFile_FID_Users_UltraBro_Documents_Unreal_Projects_Ultra_5_3_Plugins_GameFeatures_UltraCore_Source_UltraCoreRuntime_Private_Battle_PlayerSpawningManagementComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_UltraBro_Documents_Unreal_Projects_Ultra_5_3_Plugins_GameFeatures_UltraCore_Source_UltraCoreRuntime_Private_Battle_PlayerSpawningManagementComponent_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
